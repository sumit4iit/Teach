...
public class MainActivity extends Activity {
    ...
    class NetTask extends AsyncTask<Void,Void,String>{
		...
		protected String doInBackground(Void... params) {
			String results = "";
			try {
	    		Log.d("JsonParsingDemo","Doing Something Expensive");
				URL url = new URL(URL);
		    	...
		    	JSONArray geonamesArr = jObj.getJSONArray("geonames");
		    	JSONObject arrIndexObj = geonamesArr.optJSONObject(1);
		    	results = arrIndexObj.getString("toponymName");
		...
		protected void onPostExecute(String results){
	    	...
	    	Log.d("JsonParsingDemo","Results: "+results);
		}
    }
